...
function PipelinesPage() {
  ...
  const [fetchingPipelines, setFetchingPipelines] =
    useState(false);
  ...
  const validatePipeline = () => {
    ...
    if (!source.fileType) {
      ...
      setError(
        "Please select a valid CSV or JSON dataset."
      );
    ...
    if (
      ...
      setError(
        "Please enter the column name for the transformation."
      );
    ...
    if (!destination.collection.trim()) {
      ...
      setError(
        "Please enter a destination collection name."
      );
